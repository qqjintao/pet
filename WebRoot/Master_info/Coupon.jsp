				...
				<dl class="ps-side-module">
					...
					<dd class="ps-sd-md-menu">
						<a href="FinanceAction!queryAccount" class="ps-sd-md-menuName ">余额</a><a
							...
							href="FinanceAction!queryCoupon"
							class="ps-sd-md-menuName ps-sd-md-current">优惠券</a><a
				...
				<div class="personal-main fr">
					...
					<div class="personal-module">
						<div class="ps-md-hd clearfix">
							<h6 class="ps-md-hd-tit fl">我的优惠券</h6>
						</div>
						<div class="ps-md-bd myBeans">
							<span class="myBeans-span">可用优惠券：<strong
								class="myBeans-amount"> <s:if
										test="finance.Discount_coupon>0">
							有有效积分
							</s:if> <s:else>无有效积分</s:else>
							</strong></span><span class="myBeans-span">面值：<strong
								class="myBeans-amount">¥<s:property
										value="finance.Discount_coupon" /></strong>
							</span>
						</div>
					</div>
					<!-- 我的波奇豆 end -->
